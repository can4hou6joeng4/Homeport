...
const IconArrowRight = ({ size = 16 }) => (
  <LineIcon size={size}><line x1="4" y1="12" x2="20" y2="12"></line><polyline points="14 6 20 12 14 18"></polyline></LineIcon>
);
...
const IconNetwork = ({ size = 16 }) => (
  <LineIcon size={size}>
    <circle cx="12" cy="5" r="2.4"></circle>
    <circle cx="5" cy="17" r="2.4"></circle>
    <circle cx="19" cy="17" r="2.4"></circle>
    <line x1="10.8" y1="7.1" x2="6.2" y2="14.9"></line>
    <line x1="13.2" y1="7.1" x2="17.8" y2="14.9"></line>
    <line x1="7.4" y1="17" x2="16.6" y2="17"></line>
  </LineIcon>
);

const IconTerminal = ({ size = 16 }) => (
  <LineIcon size={size}>
